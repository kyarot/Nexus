...
define(['./workbox-36e57b92'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    ...
    return url.pathname.startsWith("/coordinator/") || url.pathname.startsWith("/volunteer/") || url.pathname.startsWith("/fieldworker/") || url.pathname.startsWith("/notifications") || url.pathname.startsWith("/public/");
